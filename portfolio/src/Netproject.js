...
const Netproject = () => {
    ...
    const cardsData = [
        { title: 'Setting Up a HomeLab with Ubuntu Server and Cloudflare Zero Trust', description: "In this project, I repurposed an old laptop to create a HomeLab running Ubuntu Server with multiple services like Samba network storage, Jellyfin, Uptime Kuma, and Vaultwarden. Using Cloudflare Zero Trust, I integrated these services with my personal domain for secure remote access.", path: '/home-lab' },        
